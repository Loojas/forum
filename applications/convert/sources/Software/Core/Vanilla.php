...
class _Vanilla extends \IPS\convert\Software
{
	 ...
	 */
	public function __construct( \IPS\convert\App $app )
	{
	 ...
	 *
	 * @param   $location       File location retrieved from the database
	 * @param   $uploadsPath    Configured uploads path
	...
	public function convertPrivateMessages()
	{
		...
		foreach ( $messages as $row )
		{
			...
			$topicInfo = array(
				...
				'mt_to_count'       => $row['CountParticipants'],
