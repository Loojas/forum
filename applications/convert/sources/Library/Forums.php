...
/**
 * Inherit from the Core Library so we can access or overload methods as needed (for example, we do not need to redeclare convertAttachments again here, but we can overload to do extra things if needed).
 */
class _Forums extends Core
{
	...
	public function getMethodFromMenuRows( $method )
	{
		...
		return parent::getMethodFromMenuRows( $method );
	}
