...
class _Cms extends Core
{
			...
			switch( $k )
			{
				...
				case 'convertCmsDatabaseRecords':
					...
					$return[ $k ] = array(
						...
						'source_rows'	=> $this->software->countRows( $v['table'], $v['where'] ),
						'per_cycle'		=> 100,
						'dependencies'	=> array( 'convertCmsDatabases', 'convertCmsDatabaseCategories' ),
						'link_type'		=> $links,
					);
					break;
				...
				case 'convertAttachments':
					...
					$return[ $k ] = array(
						...
						'source_rows'	=> $this->software->countRows( $v['table'], $v['where'] ),
						'per_cycle'		=> 100,
						'dependencies'	=> array( 'convertCmsDatabaseRecords', 'convertCmsDatabaseComments', 'convertCmsDatabaseReviews' ),
	...
	protected function truncate( $method )
	{
		...
		foreach( $classname::canConvert() as $k => $v )
		{
			switch( $k )
			{
				...
				case 'convertCmsBlocks':
					$return['convertCmsBlocks'] = array( 'cms_blocks' => NULL );
					break;
				...
				case 'convertCmsDatabaseCategories':
					$return['convertCmsDatabaseDategories'] = array( 'cms_database_categories' => NULL );
					break;
	...
	public function convertAttachment( $info=array(), $map=array(), $filepath=NULL, $filedata=NULL )
	{
		...
		return parent::convertAttachment( $info, $map, $filepath, $filedata );
	}
}