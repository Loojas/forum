...
class _Core extends \IPS\convert\Library
{
	...
	protected function truncate( $method )
	{
		...
		foreach( $classname::canConvert() as $k => $v )
		{
			switch( $k )
			{
				...
				case 'convertAdministrators':
					$return['convertAdministrators'] = array( 'core_administrators', array( "( row_id!=? AND row_id_type!=? ) OR ( row_id!=? AND row_id_type!=?", \IPS\Member::loggedIn()->member_id, 'member', \IPS\Member::i()->loggedIn()->member_group_id, 'group' ) );
					break;
				...
				case 'convertDnameChanges':
					$return['convertDnameChanges'] = array( 'core_dnames_change' => NULL );
					break;
				...
				case 'convertGroups':
					$return['convertGroups'] = array( 'core_groups' => array( \IPS\Db::i()->in( 'g_id', array( \IPS\Settings::i()->member_group, \IPS\Settings::i()->guest_group, \IPS\Settings::i()->admin_group ), TRUE ) ) );
					break;
				...
				case 'convertLeaderGroups':
					$return['convertLeaderGroups'] = array( 'core_leaders_groups' => NULL );
					break;
				...
				case 'convertStatusUpdates':
					$return['convertStatusUpdates'] = array( 'core_member_status_updates' => NULL );
					break;
					
				case 'convertMembers':
					$return['convertMembers'] = array( 'core_members' => array( "member_id<>?", \IPS\Member::loggedIn()->member_id ), 'core_pfields_content' => array( "member_id<>?", \IPS\Member::loggedIn()->member_id ) );
					break;
	 ...
	 */
	public function convertAttachment( $info=array(), $map=array(), $filepath=NULL, $filedata=NULL )
	{
