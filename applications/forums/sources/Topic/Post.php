...
class _Post extends \IPS\Content\Comment implements \IPS\Content\ReportCenter, \IPS\Content\EditHistory, \IPS\Content\Hideable, \IPS\Content\Reputation, \IPS\Content\Shareable, \IPS\Content\Searchable, \IPS\Content\Embeddable
{
	...
	{	
		...
		{
			return parent::searchResult( $indexData, $authorData, $itemData, $containerData, $reputationData, $reviewRating, $iPostedIn, $view, $asItem, $canIgnoreComments, $template );
		}
	}
	...
	public static function _definiteArticle( array $containerData = NULL, \IPS\Lang $lang = NULL )
	{
		...
		{
			$lang = $lang ?: \IPS\Member::loggedIn()->language();
			return $lang->addToStack( '__defart_answer', FALSE );
		}
		else
		{
			return parent::_definiteArticle( $containerData, $lang );
		}
	}
