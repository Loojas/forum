...
EOF;
	...
	public function form( &$form )
	{
		...
		{
			$form->add( new \IPS\Helpers\Form\Codemirror( 'block_content', htmlentities( $this->content, \IPS\HTMLENTITIES, 'UTF-8', TRUE ), FALSE, array(), function( $val ) {
	...
	public function __clone()
	{
		...
		$wordKey = 'widget_title_' . md5( uniqid() );
