...
class _Request extends \IPS\Content\Item implements \IPS\Content\ReadMarkers
{
	...
	public static function formElements( $item=NULL, \IPS\Node\Model $container=NULL )
	{
		...
		/* Add department */
		$return['department'] = new \IPS\Helpers\Form\Select( 'support_department', isset( \IPS\Request::i()->department ) ? intval( \IPS\Request::i()->department ) : NULL, TRUE, array( 'options' => $departments, 'toggles' => $departmentToggles ) );
		foreach ( $availableDepartments as $department )
		{
	 ...
	 * @return	int
	 */
	public function commentPageCountIncludingNotes()
	{		
		if ( $this->commentPageCountIncludingNotes === NULL )
		{
	 ...
	 * @param	\IPS\Member|NULL|FALSE	The member
	 * 									FALSE if there is no member
	 * 									NULL to use currently logged in member
	 *
	 * @return	void
	 */
