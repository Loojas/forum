...
class _generateRenewalInvoices extends \IPS\Task
{
	...
	public function execute()
	{
        ...
        $select = \IPS\Db::i()->select( '*', 'nexus_purchases', array(
            "ps_renewals>0 AND ps_invoice_pending=0 AND ps_active=1 AND ps_expire>0 AND ps_expire<? AND ps_billing_agreement IS NULL AND ( ps_grouped_renewals='' OR ps_grouped_renewals IS NULL )",
