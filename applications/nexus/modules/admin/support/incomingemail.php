...
class _incomingemail extends \IPS\Dispatcher\Controller
{
		...
		else
		{
			...
			if ( \IPS\Settings::i()->pop3_server )
			{
				try
				{
					...
					$pop3Form = $this->_pop3();
					$pop3Form->addButton( 'disable_pop3', 'link', \IPS\Http\Url::internal( 'app=nexus&module=support&controller=incomingemail&do=disablePop3' ), '', array( 'data-confirm' => '' ) );
	...
	{
		foreach ( array( 'pop3_server', 'pop3_port', 'pop3_user', 'pop3_password' ) as $k )
		{
